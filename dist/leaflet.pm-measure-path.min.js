    ...
    a.a.Line = a.a.extend({
      ...
      _finishShape: function() {
        if (
          ...
          var t = this._layer.getLatLngs();
          if (!(t.length <= 1)) {
            var e = L.polyline(t, this.options.pathOptions).addTo(this._map).showMeasurements();
            this.disable(),
      ...
      _finishShape: function(t) {
        if (
          ...
          if ((console.log(e), !(e.length <= 2))) {
            ...
            var n = L.polygon(e, this.options.pathOptions).addTo(this._map).showMeasurements();
            this.disable(),
    ...
    r.a.Rectangle = r.a.extend({
      ...
      _finishShape: function(t) {
        var e = this._startMarker.getLatLng(),
          n = t.latlng,
          r = L.rectangle([e, n], this.options.pathOptions).addTo(this._map).showMeasurements();
        this.disable(),
    ...
    r.a.Circle = r.a.extend({
      ...
      _finishShape: function(t) {
        var e = this._centerMarker.getLatLng(),
          ...
          a = L.circle(e, i).addTo(this._map).showMeasurements();
        this.disable(),
