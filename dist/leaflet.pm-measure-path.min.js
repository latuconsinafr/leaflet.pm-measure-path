!(function(t) {
  ...
  function(t, e, n) {
    var r = n(17),
      i = n(11);
    t.exports = function(t, e, n) {
      ((n === undefined || i(t[e], n)) && (n !== undefined || e in t)) ||
        r(t, e, n);
    };
  },
  function(t, e, n) {
    ...
    var r = n(41),
      i = {
        ...
        _handleSnapping: function(t) {
          ...
          if (
            (this._snapList === undefined && this._createSnapList(t),
        ...
        _checkPrioritiySnapping: function(t) {
          ...
          return (
            (e = c < this.options.snapDistance ? u : o), Object.assign({}, e)
          );
        },
        _createSnapList: function() {
          var t = this,
            ...
            n = [],
            r = this._map;
          r.off("pm:remove", this._handleSnapLayerRemoval, this),
            ...
            r.eachLayer(function(t) {
              if (
                ...
                e.push(t);
                var r = L.polyline([], { color: "red", pmIgnore: !0 });
        ...
        _calcClosestLayer: function(t, e) {
          ...
          return (
            e.forEach(function(e, i) {
              ...
              n.debugIndicatorLines[i].setLatLngs([t, a.latlng]),
                (r.distance === undefined || a.distance < r.distance) &&
                  ((r = a).layer = e);
            }),
            r
          );
        ...
        _calcLayerDistances: function(t, e) {
          ...
          return { latlng: Object.assign({}, c), segment: n, distance: r };
        },
  ...
  function(t, e, n) {
    ...
    function i(t, e, n, r, i, a, o, s) {
      ...
      return 0 === (l = (s - a) * (n - t) - (o - i) * (r - e))
        ? null !== p.x && null !== p.y && p
        : ((h = (n - t) * (u = e - a) - (r - e) * (c = t - i)),
          (u = ((o - i) * u - (s - a) * c) / l),
          (c = h / l),
          (p.x = t + u * (n - t)),
          (p.y = e + u * (r - e)),
    ...
    !(function(t, n) {
      ...
      var n = function(t, n) {
          void 0 === t && (t = e),
            ...
            (this._root = null),
            (this._size = 0),
            (this._noDuplicates = !!n);
        },
        r = { size: { configurable: !0 } };
      (n.prototype.rotateLeft = function(t) {
        ...
        (n.prototype._splay = function(t) {
          for (; t.parent; ) {
            var e = t.parent;
            e.parent
              ? e.left === t && e.parent.left === e
                ? (this.rotateRight(e.parent), this.rotateRight(e))
                : e.right === t && e.parent.right === e
                ? (this.rotateLeft(e.parent), this.rotateLeft(e))
                : e.left === t && e.parent.right === e
                ? (this.rotateRight(e), this.rotateLeft(e))
                : (this.rotateLeft(e), this.rotateRight(e))
              : e.left === t
              ? this.rotateRight(e)
              : this.rotateLeft(e);
          }
        ...
        (n.prototype.splay = function(t) {
          for (var e, n, r, i, a; t.parent; )
            (n = (e = t.parent).parent) && n.parent
              ? ((r = n.parent).left === n ? (r.left = t) : (r.right = t),
                (t.parent = r))
              ...
              t === e.left
                ? (n &&
                    (n.left === e
                      ? (e.right
                          ? ((n.left = e.right), (n.left.parent = n))
                          : (n.left = null),
                        (e.right = n),
                        (n.parent = e))
                      : (i ? ((n.right = i), (i.parent = n)) : (n.right = null),
                        (t.left = n),
                        (n.parent = t))),
                  a ? ((e.left = a), (a.parent = e)) : (e.left = null),
                  (t.right = e),
                  (e.parent = t))
                : (n &&
                    (n.right === e
                      ? (e.left
                          ? ((n.right = e.left), (n.right.parent = n))
                          : (n.right = null),
                        (e.left = n),
                        (n.parent = e))
                      : (a ? ((n.left = a), (a.parent = n)) : (n.left = null),
                        (t.right = n),
                        (n.parent = t))),
        ...
        (n.prototype.insert = function(t, e) {
          ...
          return (
            (n = { key: t, data: e, left: null, right: null, parent: r }),
            r
              ? i(r.key, n.key) < 0
                ? (r.right = n)
                : (r.left = n)
        ...
        (n.prototype.erase = function(t) {
          ...
          if (e) {
            ...
            n &&
              ...
              this.splay(i),
              (this._root = i)),
              r && (n ? (i.right = r) : (this._root = r), (r.parent = i)),
              this._size--;
          }
        }),
        ...
        (n.prototype.forEach = function(t) {
          for (var e = this._root, n = [], r = !1, i = 0; !r; )
            e
              ? (n.push(e), (e = e.left))
              : n.length > 0
              ? (t((e = n.pop()), i++), (e = e.right))
              : (r = !0);
          return this;
        }),
        (n.prototype.range = function(t, e, n, r) {
          for (
            var i = [], a = this._compare, o = this._root;
            0 !== i.length || o;
        ...
        (n.prototype.keys = function() {
          for (var t = this._root, e = [], n = [], r = !1; !r; )
            t
              ? (e.push(t), (t = t.left))
              : e.length > 0
              ? ((t = e.pop()), n.push(t.key), (t = t.right))
              : (r = !0);
          return n;
        }),
        (n.prototype.values = function() {
          for (var t = this._root, e = [], n = [], r = !1; !r; )
            t
              ? (e.push(t), (t = t.left))
              : e.length > 0
              ? ((t = e.pop()), n.push(t.data), (t = t.right))
              : (r = !0);
          return n;
        }),
          ...
          return (
            n &&
              (function i(t, e, n, r, a) {
                ...
                i(t, e, n, l, a);
                i(t, e, l + 1, r, a);
              })(t, e, 0, r - 1, this._compare),
            (this._root = (function a(t, e, n, r, i) {
              var o = i - r;
              if (o > 0) {
                var s = r + Math.floor(o / 2),
                  l = e[s],
                  u = n[s],
                  c = { key: l, data: u, parent: t };
                return (
                  (c.left = a(c, e, n, r, s)),
                  (c.right = a(c, e, n, s + 1, i)),
                  c
                );
              }
              return null;
      ...
      function p(t, e, n) {
        null === e
          ...
          : (t.isSubject === e.isSubject
            ...
            e &&
              (t.prevInResult =
                !f(e, n) || e.isVertical() ? e.prevInResult : e)),
          (t.inResult = f(t, n));
      }
      function f(t, e) {
        switch (t.type) {
      ...
      function m(t, e) {
        ...
        return n[0] > r[0]
          ...
          : (function(t, e, n, r) {
              ...
              if (0 !== _(n, t.otherEvent.point, e.otherEvent.point))
                return t.isBelow(e.otherEvent.point) ? -1 : 1;
      ...
      function y(t, e, n) {
        ...
        return (
          ...
          (r.contourId = i.contourId = t.contourId),
          m(i, t.otherEvent) > 0 && ((t.otherEvent.left = !0), (i.left = !1)),
      ...
      function L(t, e, n) {
        ...
        if (1 === i)
          return (
            g(t.point, r[0]) || g(t.otherEvent.point, r[0]) || y(t, r[0], n),
            g(e.point, r[0]) || g(e.otherEvent.point, r[0]) || y(e, r[0], n),
            1
          );
        var l = [],
          u = !1,
        ...
        return (
          ...
          (u && c) || u
            ? ((e.type = a),
              (t.type = e.inOut === t.inOut ? o : s),
              u && !c && y(l[1].otherEvent, l[0].point, n),
              2)
            : c
            ? (y(l[0], l[1].point, n), 3)
            : l[0] !== l[3].otherEvent
            ? (y(l[0], l[1].point, n), y(l[1], l[2].point, n), 3)
            : (y(l[0], l[1].point, n), y(l[3].otherEvent, l[2].point, n), 3)
        );
      }
      function k(t, e) {
        if (t === e) return 0;
      ...
      function w(t, e) {
        var n,
          ...
          a = (function(t) {
            ...
            for (n = 0, r = t.length; n < r; n++)
              (((e = t[n]).left && e.inResult) ||
                (!e.left && e.otherEvent.inResult)) &&
                a.push(e);
            for (var o = !1; !o; )
              for (o = !0, n = 0, r = a.length; n < r; n++)
                n + 1 < r &&
                  1 === m(a[n], a[n + 1]) &&
                  ((i = a[n]), (a[n] = a[n + 1]), (a[n + 1] = i), (o = !1));
        ...
        for (n = 0, r = a.length; n < r; n++)
          if (!o[n]) {
            var l = [[]];
            a[n].isExteriorRing
              ? e === c && !a[n].isSubject && s.length > 1
                ? s[s.length - 1].push(l[0])
                : s.push(l)
              : e !== c || a[n].isSubject || 0 !== s.length
              ? 0 === s.length
                ? s.push([[l]])
                : s[s.length - 1].push(l[0])
              : s.push(l);
            ...
            for (l[0].push(p); h >= n; )
              (i = a[h]),
                (o[h] = !0),
                i.left
                  ? ((i.resultInOut = !1), (i.contourId = u))
                  : ((i.otherEvent.resultInOut = !0),
                    (i.otherEvent.contourId = u)),
                (o[(h = i.pos)] = !0),
                l[0].push(a[h].point),
                (h = M(h, a, o, n));
            (i = a[(h = -1 === h ? n : h)]),
      ...
      (d.prototype.isBelow = function(t) {
        ...
        return this.left
          ? (e[0] - t[0]) * (n[1] - t[1]) - (n[0] - t[0]) * (e[1] - t[1]) > 0
          : (n[0] - t[0]) * (e[1] - t[1]) - (e[0] - t[0]) * (n[1] - t[1]) > 0;
      }),
        ...
        _down: function(t) {
          for (
            ...
            var a = 1 + (t << 1),
              ...
              s = e[a];
            if (
              (o < this.length && n(e[o], s) < 0 && ((a = o), (s = e[o])),
              n(s, i) >= 0)
            )
              break;
            (e[t] = s), (t = a);
      ...
      function j(t, e, n, r, i, a) {
        ...
        for (o = 0, s = t.length - 1; o < s; o++)
          if (
            ((l = t[o]),
            (u = t[o + 1]),
            (c = new d(l, !1, undefined, e)),
            (h = new d(u, !1, c, e)),
            (c.otherEvent = h),
            l[0] !== u[0] || l[1] !== u[1])
          ) {
            (c.contourId = h.contourId = n),
              a || ((c.isExteriorRing = !1), (h.isExteriorRing = !1)),
              m(c, h) > 0 ? (h.left = !0) : (c.left = !0);
            var p = l[0],
              f = l[1];
            (i[0] = O(i[0], p)),
              (i[1] = O(i[1], f)),
      ...
      function T(t, e, r) {
        ...
        var a = [Infinity, Infinity, -Infinity, -Infinity],
          ...
          s = (function(t, e, n, r, i) {
            ...
            for (s = 0, l = t.length; s < l; s++)
              for (u = 0, h = (a = t[s]).length; u < h; u++)
                (o = 0 === u) && B++, j(a[u], !0, B, p, n, o);
            for (s = 0, l = e.length; s < l; s++)
              for (u = 0, h = (a = e[s]).length; u < h; u++)
                (o = 0 === u),
                  i === c && (o = !1),
                  o && B++,
                  j(a[u], !1, B, p, r, o);
        ...
        return (i = (function(t, e, n, r, i) {
          var a = null;
          return (
            (n[0] > r[2] || r[0] > n[2] || n[1] > r[3] || r[1] > n[3]) &&
              (i === l
                ? (a = D)
                : i === c
                ? (a = t)
                : (i !== u && i !== h) || (a = t.concat(e))),
            a
          );
        })(t, e, a, o, r))
          ? i === D
          ...
          : w(
              (function(t, e, r, i, a, o) {
                for (
                  var s, u, h, f = new n(k), d = [], g = Math.min(i[2], a[2]);
                  0 !== t.length;
                  ...
                  if (_.left) {
                    (u = s = f.insert(_)),
                      (s = s !== (h = f.minNode()) ? f.prev(s) : null),
                      (u = f.next(u));
                    var m = s ? s.key : null;
                    if (
                      (p(_, m, o),
                      u && 2 === L(_, u.key, t) && (p(_, m, o), p(_, u.key, o)),
                      s && 2 === L(s.key, _, t))
                    ) {
                      var y = s;
                      p(m, (y = y !== h ? f.prev(y) : null) ? y.key : null, o),
                        p(_, m, o);
                    }
                  } else
                    (_ = _.otherEvent),
  ...
  function(t, e, n) {
        ...
        for (
          ...
          for (var v = 0; v < l; v++) {
            ...
            if (null !== (s = h ? c.geometries[v] : c)) {
              ...
              var k = s.type;
              switch (
                ((p = !n || ("Polygon" !== k && "MultiPolygon" !== k) ? 0 : 1),
                k)
              ) {
                case null:
                  break;
    ...
    function a(t, e) {
      ...
      switch (t.type) {
        case "FeatureCollection":
          for (
            n = 0;
            n < t.features.length && !1 !== e(t.features[n].properties, n);
            n++
          );
          break;
        case "Feature":
    ...
    function o(t, e) {
      if ("Feature" === t.type) e(t, 0);
        ...
        for (
          var n = 0;
          n < t.features.length && !1 !== e(t.features[n], n);
          n++
        );
    }
    function s(t, e) {
      ...
      for (n = 0; n < g; n++) {
        for (
          s = f ? t.features[n].geometry : d ? t.geometry : t,
            u = f ? t.features[n].properties : d ? t.properties : {},
            c = f ? t.features[n].bbox : d ? t.bbox : undefined,
            h = f ? t.features[n].id : d ? t.id : undefined,
    ...
    function l(t, e) {
      s(t, function(t, n, i, a, o) {
        ...
        switch (l) {
          ...
          case "Polygon":
            return (
              !1 !== e(r.feature(t, i, { bbox: a, id: o }), n, 0) && void 0
            );
        }
        switch (l) {
          case "MultiPoint":
        ...
        for (var u = 0; u < t.coordinates.length; u++) {
          var c = { type: s, coordinates: t.coordinates[u] };
            ...
            return (
              !1 !==
                i(t, function(i, s, p, f, d) {
                  if (l === undefined || n > u || f > c || d > h)
                    return (l = i), (u = n), (c = f), (h = d), void (o = 0);
          ...
          switch (a) {
            ...
            case "Polygon":
              for (var s = 0; s < o.length; s++)
                if (!1 === e(r.lineString(o[s], t.properties), n, i, s))
                  return !1;
          }
        }
      });
    ...
    (e.coordEach = i),
      ...
      (e.segmentReduce = function(t, e, n) {
        var r = n,
          i = !1;
        return (
          u(t, function(t, a, o, s, l) {
            (r = !1 === i && n === undefined ? t : e(r, t, a, o, s, l)),
              (i = !0);
          }),
          r
        );
      ...
      (e.findSegment = function(t, e) {
        ...
        switch (n.type) {
          ...
          case "MultiLineString":
            return (
              a < 0 && (a = u.length + a),
              s < 0 && (s = u[a].length + s - 1),
              r.lineString([u[a][s], u[a][s + 1]], l, e)
            );
          case "MultiPolygon":
            return (
              a < 0 && (a = u.length + a),
              o < 0 && (o = u[a].length + o),
              s < 0 && (s = u[a][o].length - s - 1),
              r.lineString([u[a][o][s], u[a][o][s + 1]], l, e)
            );
        }
        throw new Error("geojson is invalid");
      }),
  ...
  function(t, e) {
    t.exports = {
      ...
      license: "MIT",
      bugs: { url: "https://github.com/codeofsumit/leaflet.pm/issues" },
    ...
    var r = n(51),
      ...
      o = L.Class.extend({
        ...
        removeLayer: function(t) {
          var e = t.target;
          !(e._pmTempLayer || (e.pm && e.pm.dragging())) &&
      ...
      return r(function(e, n) {
        ...
        for (
          o = t.length > 3 && "function" == typeof o ? (a--, o) : undefined,
            s && i(n[0], n[1], s) && ((o = a < 3 ? undefined : o), (a = 1)),
            e = Object(e);
          ++r < a;
  ...
  function(t, e, n) {
    ...
    t.exports = function(t, e, n) {
      return (
        (e = i(e === undefined ? t.length - 1 : e, 0)),
        function() {
          for (
  ...
  function(t, e, n) {
    ...
    t.exports = function(t, e, n) {
      ...
      var s = typeof e;
      return (
        !!("number" == s ? i(n) && a(e, n.length) : "string" == s && e in n) &&
        r(n[e], t)
      );
    };
  },
  function(t, e) {
    t.exports = {
      ...
      buttonTitles: {
        drawMarkerButton: "Gambar Penanda",
        drawPolyButton: "Gambar Poligon",
        drawLineButton: "Gambar Polyline",
        drawCircleButton: "Gambar Lingkaran",
        drawRectButton: "Gambar Persegi",
        editButton: "Sunting Layers",
        dragButton: "Seret Layers",
        cutButton: "Potong Layers",
        deleteButton: "Hapus Layers",
        drawCircleMarkerButton: "Gambar Penanda Lingkaran"
      }
    };
  },
  function(t, e) {
  ...
  function(t, e, n) {
    ...
    var a = L.Class.extend({
      ...
      applyIconStyle: function() {
        ...
        for (var n in t) {
          var r = t[n];
          L.Util.setOptions(r, { className: e.geomanIcons[n] });
        }
      },
      removeControls: function() {
        var t = this.getButtons();
      ...
      _defineButtons: function() {
        ...
        this._addButton("drawMarker", new L.Control.PMButton(e)),
          ...
          this._addButton("drawPolygon", new L.Control.PMButton(n)),
        ...
        _makeButton: function(t) {
          ...
          o.forEach(function(t) {
            var n = s[t],
              r = L.DomUtil.create(
                "a",
                "leaflet-pm-action action-".concat(t),
                a
              );
            (r.innerHTML = n.text),
              L.DomEvent.addListener(r, "click", n.onClick, e),
  ...
  function(t, e, n) {
    ...
    t.exports = function(t, e, n) {
      ...
      return h || ++u != c
        ? h
        : !!(c = null == t ? 0 : t.length) && s(c) && o(p, c) && (a(t) || i(t));
    };
  },
  function(t, e, n) {
    "use strict";
      ...
      enable: function(t) {
        ...
        L.Util.setOptions(this, t),
          ...
          this.options.tooltips &&
            this._hintMarker
              .bindTooltip(Object(i.a)("tooltips.placeMarker"), {
                permanent: !0,
                offset: L.point(0, 10),
                direction: "bottom",
                opacity: 0.8
    ...
    a.a.Line = a.a.extend({
      ...
      enable: function(t) {
        L.Util.setOptions(this, t),
          ...
          this.options.tooltips &&
            this._hintMarker
              .bindTooltip(Object(o.a)("tooltips.firstVertex"), {
                permanent: !0,
                offset: L.point(0, 10),
                direction: "bottom",
                opacity: 0.8
      ...
      _removeLastVertex: function() {
        ...
        if (t.length < 1) this.disable();
          ...
          this._layerGroup.removeLayer(n),
      ...
      _createMarker: function(t, e) {
        ...
        return (
          ...
          n.on("click", this._finishShape, this),
          e &&
            this._hintMarker.setTooltipContent(
              Object(o.a)("tooltips.continueLine")
            ),
          2 === this._layer.getLatLngs().length &&
            this._hintMarker.setTooltipContent(
              Object(o.a)("tooltips.finishLine")
            ),
          n
        );
      }
    ...
    r.a.Polygon = r.a.Line.extend({
      ...
      _finishShape: function(t) {
        if (
          ...
          if (!(e.length <= 2)) {
            ...
            var n = L.polygon(e, this.options.pathOptions)
              .addTo(this._map)
              .showMeasurements();
            this.disable(),
      ...
      _createMarker: function(t, e) {
        ...
        return (
          ...
          e &&
            (n.on("click", this._finishShape, this),
            (this._tempSnapLayerIndex = this._otherSnapLayers.push(n) - 1),
            this.options.snappable && this._cleanupSnapping()),
          e &&
            this._hintMarker.setTooltipContent(
              Object(i.a)("tooltips.continueLine")
            ),
          3 === this._layer.getLatLngs().length &&
            this._hintMarker.setTooltipContent(
              Object(i.a)("tooltips.finishPoly")
            ),
          n
        );
      }
    ...
    r.a.Rectangle = r.a.extend({
      ...
      enable: function(t) {
        if (
          ...
          this.options.tooltips &&
            this._hintMarker
              .bindTooltip(Object(i.a)("tooltips.firstVertex"), {
                permanent: !0,
                offset: L.point(0, 10),
                direction: "bottom",
                opacity: 0.8
      ...
      _placeStartingMarkers: function(t) {
        ...
        L.DomUtil.addClass(this._startMarker._icon, "visible"),
          ...
          this._hintMarker.setTooltipContent(
            Object(i.a)("tooltips.finishRect")
          ),
      ...
      _finishShape: function(t) {
        var e = this._startMarker.getLatLng(),
          n = t.latlng,
          r = L.rectangle([e, n], this.options.pathOptions)
            .addTo(this._map)
            .showMeasurements();
        this.disable(),
    ...
    r.a.Circle = r.a.extend({
      ...
      enable: function(t) {
        L.Util.setOptions(this, t),
          ...
          this.options.tooltips &&
            this._hintMarker
              .bindTooltip(Object(i.a)("tooltips.startCircle"), {
                permanent: !0,
                offset: L.point(0, 10),
                direction: "bottom",
                opacity: 0.8
      ...
      _placeCircleCenter: function() {
        ...
        t &&
          ...
          this._hintMarker.setTooltipContent(
            Object(i.a)("tooltips.finishCircle")
          ),
      ...
      _finishShape: function(t) {
        var e = this._centerMarker.getLatLng(),
          n = t.latlng,
          r = e.distanceTo(n),
          i = Object.assign({}, this.options.pathOptions, { radius: r }),
          a = L.circle(e, i)
            .addTo(this._map)
            .showMeasurements();
        this.disable(),
          this._map.fire("pm:create", { shape: this._shape, layer: a });
      },
      _createMarker: function(t) {
    ...
    r.a.CircleMarker = r.a.Marker.extend({
      ...
      enable: function(t) {
        ...
        L.Util.setOptions(this, t),
          ...
          this.options.tooltips &&
            this._hintMarker
              .bindTooltip(Object(i.a)("tooltips.placeCircleMarker"), {
                permanent: !0,
                offset: L.point(0, 10),
                direction: "bottom",
                opacity: 0.8
      ...
      _cut: function(t) {
        ...
        Object.keys(n)
          ...
          .forEach(function(n) {
            ...
            if (typeof r.geometry.coordinates[0][0][0] == 'object'){
              var rotatedRCoordinates = [];
              for (var j = 0; j < r.geometry.coordinates.length; j++) {
                rotatedRCoordinates[j] = [];
                for (var k = 0 ; k < r.geometry.coordinates[j][0].length; k++){
                  rotatedRCoordinates[j].push([r.geometry.coordinates[j][0][k][1], r.geometry.coordinates[j][0][k][0]]);
                }
                var i = L.polygon(rotatedRCoordinates[j], e.options.pathOptions).addTo(e._map).showMeasurements();

                i.addTo(e._map),
                  i.pm.enable(e.options),
                  i.pm.disable(),
                  n.fire("pm:cut", { shape: e._shape, layer: i, originalLayer: n }),
                  e._map.fire("pm:cut", {
                    shape: e._shape,
                    layer: i,
                    originalLayer: n
                  ...
                  n.remove(),
                  t.remove(),
                  0 === rotatedRCoordinates.length &&
                    e._map.pm.removeLayer({ target: i });
              }
            }else{
              var rotatedRCoordinates = [];
              for (var i = 0; i < r.geometry.coordinates[0].length; i++) {
                rotatedRCoordinates.push([r.geometry.coordinates[0][i][1], r.geometry.coordinates[0][i][0]]);
              }
              var i = L.polygon(rotatedRCoordinates, e.options.pathOptions).addTo(e._map).showMeasurements();
  ...
  function(t, e, n) {
    ...
    function u(t) {
      switch (t.type) {
        ...
        case "MultiPolygon":
          var e = [];
          if (
            (Object(l.flattenEach)(t, function(t) {
    ...
    e.a = function(t, e) {
      ...
      return 0 === l.length
        ? null
        : 1 === l.length
        ? Object(o.polygon)(l[0], a)
        : Object(o.multiPolygon)(l, a);
    };
  },
  function(t, e, n) {
    "use strict";
      ...
      if (c > 2) {
        for (l = 0; l < c; l++)
          l === c - 2
            ...
            (e = t[r]),
            (n = t[a]),
            (u += (s(t[o][0]) - s(e[0])) * Math.sin(s(n[1])));
        u = (u * i * i) / 2;
      }
      return u;
    }
    ...
    s.a.Line = s.a.extend({
        ...
        if (this.hasSelfIntersection()) {
          ...
          t
            ? (n.setStyle({ color: "red" }),
              (this.isRed = !0),
              window.setTimeout(function() {
                n.setStyle({ color: e.cachedColor }), (e.isRed = !1);
              }, 200))
            : (n.setStyle({ color: "red" }), (this.isRed = !0)),
            this._layer.fire("pm:intersect", {
              intersection: i()(this._layer.toGeoJSON(15))
            });
        } else n.setStyle({ color: this.cachedColor }), (this.isRed = !1);
      },
      ...
      _createMiddleMarker: function(t, e) {
        ...
        return (
          ...
          i.on("click", function() {
            var r = L.divIcon({ className: "marker-icon" });
      ...
      _removeMarker: function(t) {
        ...
        if (a) {
          ...
          if (
            ...
            Object(u.b)(r) && this._layer.remove(),
            n._middleMarkerPrev &&
              this._markerGroup.removeLayer(n._middleMarkerPrev),
            n._middleMarkerNext &&
              this._markerGroup.removeLayer(n._middleMarkerNext),
            this._markerGroup.removeLayer(n),
            this.isPolygon()
              ? ((c = (s + 1) % f.length),
                (h = (s + (f.length - 1)) % f.length))
              : ((h = s - 1 < 0 ? undefined : s - 1),
                (c = s + 1 >= f.length ? undefined : s + 1)),
            c !== h)
          ) {
            var d = f[h],
              g = f[c];
      ...
      findDeepMarkerIndex: function(t, e) {
        ...
        t.some(
          (function i(t) {
            return function(r, a) {
              var o = t.concat(a);
              return r._leaflet_id === e._leaflet_id
                ? ((n = o), !0)
                : Array.isArray(r) && r.some(i(o));
            };
          })([])
        );
        var r = {};
      ...
      updatePolygonCoordsFromMarkerDrag: function(t) {
        var e = this._layer.getLatLngs(),
          ...
          a = r.index,
          s = r.parentPath;
        (i.length > 1 ? o()(e, s) : e).splice(a, 1, n),
      ...
      _onMarkerDragEnd: function(t) {
        ...
        this._layer.fire("pm:markerdragend", { markerEvent: t, indexPath: n }),
          this._fireEdit();
      },
    ...
    r.a.Rectangle = r.a.Polygon.extend({
      ...
      _createMarker: function(t, e) {
        ...
        return (
          ...
          (n._index = e),
          (n._pmTempLayer = !0),
          n.on("dragstart", this._onMarkerDragStart, this),
          n.on("drag", this._onMarkerDrag, this),
          n.on("dragend", this._onMarkerDragEnd, this),
          n.on("pm:snap", this._adjustRectangleForMarkerSnap, this),
          this.options.preventMarkerRemoval ||
            n.on("contextmenu", this._removeMarker, this),
      ...
      _onMarkerDragStart: function(t) {
        var e = t.target,
          n = this._findCorners();
        (e._oppositeCornerLatLng = n[(e._index + 2) % 4]),
          (e._snapped = !1),
  ...
  function(t, e, n) {
    ...
    r.a.Circle = r.a.extend({
      ...
      _createHintLine: function(t, e) {
        var n = t.getLatLng(),
          r = e.getLatLng();
        (this._hintline = L.polyline([n, r], this.options.hintlineStyle)),
          (this._hintline._pmTempLayer = !0),
